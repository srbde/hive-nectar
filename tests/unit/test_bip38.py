...
def test_encrypt():
    assert [
        ...
        format(
            encrypt(PrivateKey("5HtasZ6ofTHP6HCwTqTkLDuLQisYPah7aUnSKfC7h4hMUVw2gi5"), "Satoshi"),
            "encwif",
        ),
    ] == [
...
def test_deencrypt():
    assert [
        ...
        format(
            decrypt("6PRNFFkZc2NZ6dJqFfhRoFNMR9Lnyj7dYGrzdgXXVMXcxoKTePPX1dWByq", "Satoshi"),
            "wif",
        ),
    ] == [
